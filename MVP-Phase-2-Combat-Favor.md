...
| **No-Elimination Respawn** | • What is dead may never die: any ship reduced to 0 crew **immediately respawns at its home port** — flagship with 1 crew, standard longship as an empty hull (0 crew).<br>• Defeat fueling miracles: 1 Favor gained per 2 crew lost in combat. |
...
6. **No Elimination**: A ship wiped in combat immediately respawns at its home port (flagship with 1 crew, longship with 0 crew).
