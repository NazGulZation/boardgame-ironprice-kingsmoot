...
**No elimination.** What is dead may never die: any ship reduced to 0 crew waits off-board and washes ashore at its home port at the start of its owner's next turn — flagship with 1 crew, standard longship as an empty hull (0 crew). Losing gives Favor (1 per 2 crew lost) — defeat fuels miracles.
